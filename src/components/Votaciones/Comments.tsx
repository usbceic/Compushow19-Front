...
export default function Comments(props: any) {
    ...
    return (
        <Grid item xs={12} sm={6} className={classes.commentsMobile}
            style={{ paddingTop: props.comment.id % 2 == 0? '20px': '0'}}
        >
            <Card className={classes.commentsDivMobile}
                style={{ margin: '40px', maxWidth: '280px', maxHeight: '220px', borderRadius: '5px' }}>
